...
contract Ownable {
    ...
    function setMaster(address _newMaster) internal {
        ...
        xxx_track_master = "Ownable.setMaster(address _newMaster)";
        xxx_track_mapping_master["Ownable.setMaster(address _newMaster)"] = _newMaster;
    }
    ...
    bytes xxx_track_master;
    mapping (bytes => address) xxx_track_mapping_master;
}
pragma solidity ^ 0.5.0;
...
contract Proxy is Upgradeable, UpgradeableMaster, Ownable {
    ...
    constructor(address target, bytes memory targetInitializationParameters) Ownable(msg.sender) public {
        ...
        assert(xxx_track_mapping_master[xxx_track_master] == getMaster());
